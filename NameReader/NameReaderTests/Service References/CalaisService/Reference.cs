...
namespace NameReaderTests.CalaisService {
    ...
    public interface calaisSoap {
        ...
        NameReaderTests.CalaisService.EnlightenResponse Enlighten(NameReaderTests.CalaisService.EnlightenRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://clearforest.com/Enlighten", ReplyAction="*")]
        System.Threading.Tasks.Task<NameReaderTests.CalaisService.EnlightenResponse> EnlightenAsync(NameReaderTests.CalaisService.EnlightenRequest request);
    }
    ...
    public partial class EnlightenRequest {
        ...
        public NameReaderTests.CalaisService.EnlightenRequestBody Body;
        
        public EnlightenRequest() {
        }
        
        public EnlightenRequest(NameReaderTests.CalaisService.EnlightenRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class EnlightenResponse {
        ...
        public NameReaderTests.CalaisService.EnlightenResponseBody Body;
        
        public EnlightenResponse() {
        }
        
        public EnlightenResponse(NameReaderTests.CalaisService.EnlightenResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface calaisSoapChannel : NameReaderTests.CalaisService.calaisSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class calaisSoapClient : System.ServiceModel.ClientBase<NameReaderTests.CalaisService.calaisSoap>, NameReaderTests.CalaisService.calaisSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        NameReaderTests.CalaisService.EnlightenResponse NameReaderTests.CalaisService.calaisSoap.Enlighten(NameReaderTests.CalaisService.EnlightenRequest request) {
            return base.Channel.Enlighten(request);
        }
        
        public string Enlighten(string licenseID, string content, string paramsXML) {
            NameReaderTests.CalaisService.EnlightenRequest inValue = new NameReaderTests.CalaisService.EnlightenRequest();
            inValue.Body = new NameReaderTests.CalaisService.EnlightenRequestBody();
            inValue.Body.licenseID = licenseID;
            inValue.Body.content = content;
            inValue.Body.paramsXML = paramsXML;
            NameReaderTests.CalaisService.EnlightenResponse retVal = ((NameReaderTests.CalaisService.calaisSoap)(this)).Enlighten(inValue);
            return retVal.Body.EnlightenResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<NameReaderTests.CalaisService.EnlightenResponse> NameReaderTests.CalaisService.calaisSoap.EnlightenAsync(NameReaderTests.CalaisService.EnlightenRequest request) {
            return base.Channel.EnlightenAsync(request);
        }
        
        public System.Threading.Tasks.Task<NameReaderTests.CalaisService.EnlightenResponse> EnlightenAsync(string licenseID, string content, string paramsXML) {
            NameReaderTests.CalaisService.EnlightenRequest inValue = new NameReaderTests.CalaisService.EnlightenRequest();
            inValue.Body = new NameReaderTests.CalaisService.EnlightenRequestBody();
            inValue.Body.licenseID = licenseID;
            inValue.Body.content = content;
            inValue.Body.paramsXML = paramsXML;
            return ((NameReaderTests.CalaisService.calaisSoap)(this)).EnlightenAsync(inValue);
        }
    }
}
